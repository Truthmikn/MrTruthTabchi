...
{
const Report = '@Kho0n'; // یوزرنیم کانال یا کاربر برای ارسال لاگ ها
...
💡 Size : " . $size . 'MB',
                    ...
                    if (preg_match("/^[\/\#\!]?(delanswer) (.*)$/si", $text)) {
                        ...
                        if (isset($data['answering'][$txxt])) {
                            ...
                            yield $this->messages->sendMessage(['peer' => $peer, 'message' => "**֍ 𝑻𝒉𝒊𝒔 𝑾𝒐𝒓𝒅 𝑰𝒔 𝑴𝒊𝒔𝒔𝒊𝒏𝒈 𝑰𝒏 𝑻𝒉𝒆 ??𝒏𝒔𝒘𝒆𝒓 𝑳𝒊𝒔𝒕!**", 'parse_mode' => 'markdown']);
                        }
                    }
